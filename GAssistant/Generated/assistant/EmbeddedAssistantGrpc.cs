...
namespace Google.Assistant.Embedded.V1Alpha2 {
  ...
  public static partial class EmbeddedAssistant
  {
    ...
    [grpc::BindServiceMethod(typeof(EmbeddedAssistant), "BindService")]
    ...
    public partial class EmbeddedAssistantClient : grpc::ClientBase<EmbeddedAssistantClient>
    {
      ...
      public EmbeddedAssistantClient(grpc::ChannelBase channel) : base(channel)
      {
      }
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, EmbeddedAssistantBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_Assist, serviceImpl == null ? null : new grpc::DuplexStreamingServerMethod<global::Google.Assistant.Embedded.V1Alpha2.AssistRequest, global::Google.Assistant.Embedded.V1Alpha2.AssistResponse>(serviceImpl.Assist));
    }
